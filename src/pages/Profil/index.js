...
function Profil() {
  ...
  const [liveUpdateAvatar, setLiveUpdateAvatar] = useState("")
  return (
            ...
            <div className="col-10 col-lg-4 my-2 my-lg-5 mx-auto">
              <div className="card-profil bg-white py-4 px-4 text-center shadow">
                <div
                  ...
                  onClick={clickImg}
                >
                  <img src={liveUpdateAvatar === "" ? dataUser.avatar : liveUpdateAvatar} className="rounded-circle w-100" />
                ...
                <div className="my-2 d-none">
                  <input
                    ...
                    onChange={(e) => {
                        ...
                        reader.addEventListener("load", () => { setLiveUpdateAvatar(reader.result) })
