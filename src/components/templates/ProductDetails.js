      ...
      <div className="showInAnimation productDetails">
         ...
         <div className="productDetailPage">
            <div className="displayColumn leftProductDetails rubikFont">
               ...
               <div className="hideThisInDesktop"><CustomButton bgClr="#6A4029" brRad="2.5vw" btnPdg="2.5vw" ftSize="5.5vw" mrgn="0.77vw 0" txClr="white" value="Add to Cart" wd="100%"/></div>
               <div className="hideThisInMobile"><CustomButton bgClr="#6A4029" brRad="1vw" btnPdg="1vw 3vw" ftSize="1.1vw" ftWg="bold" mrgn="0.77vw 0" txClr="white" value="Add to Cart" wd="100%"/></div>
               {userData.role === "admin" 
               ?
               <div>
